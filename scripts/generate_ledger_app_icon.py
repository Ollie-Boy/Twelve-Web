#!/usr/bin/env python3
"""Ledger app icon: sky blue + pencil stick figure (ledger / step pose, ~6 strokes)."""
...
from icon_pencil_stickman import compose_ledger_icon  # noqa: E402
